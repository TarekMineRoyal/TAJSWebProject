...
public class SqlRoleManagerRepository<TEntity> : IRoleManagerRepository<TEntity> where TEntity : class
{
    private readonly CustomIdentityDbContext userDbContext;
    private readonly DbSet<TEntity> _dbSet;

    public SqlRoleManagerRepository(CustomIdentityDbContext userDbContext)
    {
